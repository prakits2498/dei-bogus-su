...
public class ForeignAgent extends Thread{
	...
	//MBT: <home_address, care_of_address, mac_address, association_lifetime>
	private HashMap<String, ForeignAgentData> mobilityBindingTable = new HashMap<String, ForeignAgentData>();
	private ArrayList networkNodes = new ArrayList();

	public ForeignAgent(Socket clientSocket, ObjectInputStream in, ObjectOutputStream out) throws ClassNotFoundException {
