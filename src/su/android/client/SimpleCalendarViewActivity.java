						...
						for (int i = 1; i <= daysInMonth; i++)
							{
								...
								if (i == getCurrentDayOfMonth() && mm == Calendar.getInstance(Locale.getDefault()).get(Calendar.MONTH)+1 && yy == Calendar.getInstance(Locale.getDefault()).get(Calendar.YEAR))
									{
				...
				private HashMap findNumberOfEventsPerMonth(int year, int month)
					{
						...
						MonthlyEventsRequest context = new MonthlyEventsRequest(month, year, 2006105059);
						map = conn.checkEvents(context);
				...
				public View getView(int position, View convertView, ViewGroup parent)
					{
						...
						if ((!eventsPerMonthMap.isEmpty()) && (eventsPerMonthMap != null))
							...
							Log.i("Eventos","não tem nepiaaaaaaaaaaaaaaaa");
